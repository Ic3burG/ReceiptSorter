...
public actor FileOrganizationService {
    ...
    public func organizeReceiptWithConflictDetection(_ fileURL: URL, date: String) async throws -> OrganizationResult {
        // Validate file exists
        guard fileManager.fileExists(atPath: fileURL.path) else {
            throw FileOrganizationError.fileNotFound(fileURL)
        }
    ...
    public func resolveConflict(
        ...
        case .keepBoth:
            ...
            let uniqueURL = generateUniqueDestination(folder: folder, filename: sourceURL.lastPathComponent)
