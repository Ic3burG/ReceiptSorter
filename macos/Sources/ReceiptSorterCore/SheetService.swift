...
public actor SheetService {
  ...
  public func appendReceipt(_ data: ReceiptData) async throws {
    try await authService.performAction { accessToken in
      let url = URL(
        string:
          "https://sheets.googleapis.com/v4/spreadsheets/\(self.sheetID)/values/A1:append?valueInputOption=USER_ENTERED"
      )!
  ...
  public func formatHeader() async throws {
    try await authService.performAction { accessToken in
      ...
      guard let firstSheet = spreadsheet.sheets.first,
        let sheetId = firstSheet.properties.sheetId
      else {
      ...
      let url = URL(
        string: "https://sheets.googleapis.com/v4/spreadsheets/\(self.sheetID):batchUpdate")!
      var request = URLRequest(url: url)
      request.httpMethod = "POST"
      request.setValue("Bearer \(accessToken)", forHTTPHeaderField: "Authorization")
      request.setValue("application/json", forHTTPHeaderField: "Content-Type")
      ...
      let batchUpdate = BatchUpdateRequest(requests: [
            ...
            cell: CellData(
              userEnteredFormat: CellFormat(
                ...
                textFormat: TextFormat(
                  foregroundColor: Color(red: 1, green: 1, blue: 1), bold: true, fontSize: 11),
        ...
        Request(
          repeatCell: RepeatCellRequest(
            range: GridRange(
              sheetId: sheetId, startRowIndex: 1, startColumnIndex: 4, endColumnIndex: 5),
            cell: CellData(
              userEnteredFormat: CellFormat(
...
private struct Request: Encodable {
  ...
  init(
    updateSheetProperties: UpdateSheetPropertiesRequest? = nil, repeatCell: RepeatCellRequest? = nil
  ) {
...
private struct GridRange: Encodable {
  ...
  init(
    sheetId: Int, startRowIndex: Int? = nil, endRowIndex: Int? = nil, startColumnIndex: Int? = nil,
    endColumnIndex: Int? = nil
  ) {
    self.sheetId = sheetId
...
private struct CellFormat: Encodable {
  ...
  init(
    backgroundColor: Color? = nil, textFormat: TextFormat? = nil,
    horizontalAlignment: String? = nil, numberFormat: NumberFormat? = nil
  ) {
