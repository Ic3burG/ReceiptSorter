...
### Phase 3.5: Model Pre-download on First Launch (Complete)
...
**Current State**: Model downloads on first launch with clear progress UI  
...
### Phase 6a: Liquid Glass Design System (Superseded)

_Goal: Elevate visual design with premium, modern aesthetics._

**Status**: Replaced by Native SwiftUI Adoption (ADR-001) for improved maintainability and performance. Custom components were removed in favor of standard system components to ensure best-in-class accessibility and native feel.
...
- [x] **Local LLMs (via Ollama/MLX)**: Privacy-focused, offline processing using models like Qwen 2.5 or Mistral running locally on Apple Silicon
